        ...
        <main className="h-[90vh] overflow-y-auto flex justify-center items-center  px-5 w-screen bg-no-repeat bg-cover  "  style={{backgroundImage:"url(/resumeBg.jpg)"}}  >
            <div className="flex flex-col items-center justify-start backdrop-blur-sm border-2 border-[#15254c]  gap-1 p-2  rounded-md md:rounded-l-md h-[550px] w-[350px] z-[17] md:w-[300px]  "  >
                ...
                <div className="w-full flex flex-col gap-2 items-start  px-5 font-bold text-white " >
                    <Link href="login" className="font-bold text-white" >Forgotten Password</Link>
                    <hr className="h-1 w-32 rounded bg-[#15254c]" />
                    <div className="w-full flex gap-5 justify-between items-center text-[15px]   font-bold text-white" >
                        <p>Don't have an account </p>
                        <Link href="register" className="p-2 rounded font-bold  text-center  text-gray-300 bg-[#15254c] " >Register</Link>
                    </div>
                </div>
            </div>
        </main>
