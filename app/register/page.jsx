...
export default function AuthSignup(){
    return(
    <main className=" h-screen flex justify-center items-center   mx-auto px-2 bg-no-repeat bg-cover "  style={{backgroundImage:"url(/resumeBg.jpg)"}}  >
            <div className="flex flex-col items-center justify-start backdrop-blur-sm border-2 border-[#15254c]  gap-1 p-2  rounded-md md:rounded-l-md h-[550px] w-[400px] md:w-[400px]  "  >
                ...
                <div className="flex flex-col items-center gap-5 my-7 " >
                    ...
                    <Link href="register" className="p-2 rounded w-[60%] font-bold  text-center  text-gray-300 bg-[#15254c] " >Signup with Google</Link>
                </div>
