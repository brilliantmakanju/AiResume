...
export default function HomeIntro() {
  return (
    <>
      <section className=" mb-[50px] lg:snap-always lg:snap-start w-auto md:justify-between md:flex-row flex-col-reverse  md:items-center gap-4 xl:gap-2  md:px-20 overflow-hidden  bg-no-repeat bg-cover bg-center bg-fixed xl:h-[80%] lg:hidden  ">
        <HomeIntroImage />
        <HomeIntroText />
      </section>
