...
export default function OurWork() {
  return (
    <section className="lg:snap-always lg:snap-start px-5 md:mx-auto lg:px-20 grid grid-cols-1 gap-10 md:flex-wrap pt-[14%] md:pt-[10%] md:pb-[5%] bg-[#1481ba]  ">
      ...
      <div className=" grid grid-cols-1 gap-8 rounded-md py-3 md:flex md:flex-wrap place-content-center lg:px-[1px] md:gap-5">
        <OurWorkList
          title="Work Faster"
