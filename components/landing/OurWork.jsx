...
export default function OurWork() {
  return (
    <section className="lg:snap-always lg:snap-start px-5 lg:mx-auto lg:px-20 grid grid-cols-1 gap-10 md:flex-wrap pt-[14%] md:pt-[10%] md:pb-[5%]   ">
      ...
      <div className=" flex flex-row flex-wrap gap-8 rounded-md py-3  lg:place-content-center lg:px-[1px] md:gap-5">
        <OurWorkList
          title="Work Faster"
