...
export default function OurWorkList(){
    return(
        <div className="md:bg-[#b3b0ac] grid grid-cols-1 gap-5 rounded-md py-10 md:flex md:flex-wrap md:gap-20 md:place-content-center  lg:px-20 lg:grid-cols-3 md:gap-5"  >
          <div className="bg-[#c6c3be] relative rounded-md shadow-md shadow-black mx-auto h-[500px] w-[400px] px-5 py-5 hover:shadow-lg hover:shadow-[#15254c] hover:scale-2 duration-300 transition ease-in-out " >
                <Image
                    width={250}
                    alt="Resume"
                    height={150}
                ...
                <Link href="/" className=" absolute bottom-3 bg-[#15254c] text-white w-full px-16 ml-1 rounded-md font-bold py-2 " >Build Resume</Link>
          </div>
